...
<body class="bg-background font-helvetica min-h-screen">
        ...
        <aside class="sidebar fixed left-0 top-0 h-screen w-64 bg-sidebar text-white flex flex-col z-50 transition-transform duration-300 lg:translate-x-0" id="sidebar">
            ...
            <nav class="flex-1 py-6 px-3">
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="{{ route('user.reservasi') }}" class="nav-link flex items-center gap-3 px-4 py-3 rounded-lg text-white/60 hover:bg-white/10 hover:text-white transition-all duration-200">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="p-4 lg:p-6 border-b border-gray-100">
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <select id="filterBuilding" class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors">
    ...
    <script>
        window.__DASHBOARD_API__ = {
            ...
            buildings: '{{ route('user.api.accessibleBuildings') }}',
            rooms: '{{ route('user.api.accessibleRooms') }}',
            bookingDetail: '{{ route('user.api.booking.detail', ['id' => '__ID__']) }}'
        };
    </script>
