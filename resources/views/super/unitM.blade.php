            ...
            <div class="modal-content w-full max-w-md sm:max-w-lg">
                ...
                <form id="unitForm" class="p-5 lg:p-6">
                    ...
                    <div class="space-y-5">
                        <!-- Kode Unit -->
                        <div>
                            <label for="kodeUnit" class="block text-sm font-semibold text-gray-700 mb-2">Kode Unit <span class="text-red-500">*</span></label>
                            <input type="text" id="kodeUnit" name="kode_unit" class="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all capitalize" placeholder="Contoh: UX001A" maxlength="20" required>
                            <p class="mt-1 text-xs text-gray-500">Kode unik unit (huruf dan angka saja)</p>
                        </div>
    ...
    <div class="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" id="statusModal" style="display: none;">
        <div class="modal-content bg-white rounded-3xl shadow-2xl max-w-md w-full overflow-hidden transform transition-all duration-300">
            ...
            <div class="p-5 lg:p-6">
                ...
                <div class="bg-amber-50 border border-amber-100 rounded-xl p-4 mb-4" id="statusDeactivateWarning" style="display: none;">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="text-sm text-amber-700">
                            <p class="font-medium">Perhatian!</p>
                            <p class="mt-1">Jika unit dinonaktifkan:</p>
                            <ul class="list-disc list-inside mt-1 space-y-0.5">
                                <li>User tidak dapat membuat reservasi di unit ini</li>
                                <li>Admin tidak dapat menyetujui reservasi di unit ini</li>
                                <li>Unit tidak akan muncul di dropdown reservasi</li>
                            </ul>
                        </div>
                    </div>
                </div>
